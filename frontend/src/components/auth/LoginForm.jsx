...
const LoginForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-surface-800 rounded-xl border border-white/5">
      <h2 className="text-2xl font-bold text-center mb-6 text-slate-100">Login to {APP_NAME}</h2>
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-surface-800 text-slate-500">Or continue with</span>
          </div>
        </div>
        ...
        <div className="mt-4 space-y-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-[#1DB954] hover:bg-[#1aa34a] text-white font-medium py-2.5 px-4 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-surface-700 hover:bg-surface-600 text-slate-300 font-medium py-2.5 px-4 rounded-xl border border-white/5 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
          >
            <img
